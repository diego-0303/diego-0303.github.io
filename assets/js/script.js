...
function getSwitchOnSVG(fillColor) {
  return `<svg style="width: 48; height: 48" viewBox="-20 0 190 190" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function getSwitchOffSVG(fillColor) {
  return `style="width: 48; height: 48" viewBox="-20 0 190 190" fill="none" xmlns="http://www.w3.org/2000/svg">
