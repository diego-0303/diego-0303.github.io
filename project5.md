...
<div style="max-width: 760px; margin: 40px auto; font-family: inherit; line-height: 1.7; padding: 0 15px;">
  ...
  <div style="background: #f7f7f8; border-radius: 8px; padding: 18px 22px; margin-bottom: 30px; font-size: 0.95rem;">
    <div style="display: grid; grid-template-columns: 110px 1fr; row-gap: 6px;">
      ...
      <strong>Team</strong><span>CRATER grew from about 6 people to about 20 over my two years on the team</span>
  ...
  <p>
    By the time I graduated, the joint was at a first-prototype stage rather than a fully validated one: its 3D-printed structural components and motor housings weren't able to hold up under real load conditions, which is a separate problem from the gearing choice above and would have been the next thing to redesign in metal. The arm joint testing footage below was shot by teammates shortly after I graduated.
  </p>
  ...
  <figure style="margin: 35px 0; text-align: center;">
    <img src="https://diego-0303.github.io/images/ERNIE2.jpeg" alt="ERNIE Rover Assembled Hardware" style="max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 16px rgba(0,0,0,0.08);">
    <figcaption style="margin-top: 10px; font-size: 0.9rem; color: #666; font-style: italic;">Figure 3: The original ERNIE chassis with rocker-bogie suspension during mobility testing.</figcaption>
  </figure>
  ...
  <figure style="margin: 35px 0; text-align: center;">
    ...
    <figcaption style="margin-top: 10px; font-size: 0.9rem; color: #666; font-style: italic;">Figure 4: The later ERNIE hardware generation, with a new chassis from Protocase.</figcaption>
  </figure>
  ...
  <figure style="margin: 35px 0; text-align: center;">
    ...
    <figcaption style="margin-top: 10px; font-size: 0.9rem; color: #666; font-style: italic;">Figure 5: ERNIE at the CIRC platform demonstration.</figcaption>
  </figure>

  <p>
    ERNIE was where I learned that a mechanically elegant design and a buildable one aren't always the same thing, especially with the tooling and experience level of an undergraduate team, and that recognizing that gap early is its own kind of engineering judgment.
  </p>
</div>
